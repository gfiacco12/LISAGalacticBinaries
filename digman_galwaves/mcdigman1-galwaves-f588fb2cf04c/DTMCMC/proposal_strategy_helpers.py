...
class ProposalStrategyParameters():
    ...
    def __init__(self,
                 ...
                 fisher_subspace_frac=0.5,           # what fraction of dimensions to include in fisher subspace jumps
                 fisher_subspace_override_frac=0.5,  # how often to not do subspace jumps when doing a fisher jump
