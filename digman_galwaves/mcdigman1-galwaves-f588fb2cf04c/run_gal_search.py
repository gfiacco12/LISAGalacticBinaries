...
if __name__ == '__main__':
    ...
    fdot, fddot = rwt.TruthParamsCalculator(10.e-3, 0.522*wc.MSOLAR, 1.2*wc.MSOLAR)
    params_true = np.array([1.e-22,  10.e-3, fdot, fddot, np.log(10*wc.KPCSEC), 1.2*wc.MSOLAR, 0.522*wc.MSOLAR, -0.26,  4.6, 0.25,  1.5,  1.6])  # true parameters for search -- Add in total mass and chirp mass
